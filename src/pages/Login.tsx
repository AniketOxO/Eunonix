    ...
    <div className="min-h-screen bg-gradient-to-br from-sand-50 via-lilac-50 to-golden-50 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-light text-ink-900 mb-2">Welcome back</h1>
          <p className="text-ink-600">Sign in to continue your journey</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white/60 text-ink-500">Or continue with</span>
              </div>
            </div>
